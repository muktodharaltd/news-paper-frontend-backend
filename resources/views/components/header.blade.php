<div
    ...
    <div id="site-header-shell" class="fixed top-0 left-0 w-full max-w-full z-50 bg-white md:relative md:z-auto border-b border-slate-100 md:border-b-0 shadow-sm md:shadow-none overflow-x-clip">
        ...
        <!-- Placeholder for sticky nav (desktop) -->
        ...
        <nav
            ...
            :class="isSticky ? 'py-1 md:fixed md:top-0 md:left-0 md:w-full md:py-1 max-md:shadow-[0_10px_32px_-6px_rgba(15,23,42,0.16),0_-10px_32px_-6px_rgba(15,23,42,0.16)] md:shadow-none' : 'relative py-1 md:pt-2 md:pb-0 max-md:shadow-[0_6px_22px_-4px_rgba(15,23,42,0.12),0_-6px_22px_-4px_rgba(15,23,42,0.12)] md:shadow-none'">
            <div class="container">
                <div
