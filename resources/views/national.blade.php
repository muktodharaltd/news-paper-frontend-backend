                            ...
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    ...
                                    <span class="text-xs font-medium text-gray-500">
                                        {{ list_published_at(\Carbon\Carbon::parse('2026-03-06 07:00:00')) }}
                                    </span>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="flex flex-col md:flex-row gap-2 md:gap-4 last:pb-0">
                            ...
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    ...
                                    <span class="text-xs font-medium text-gray-500">
                                        {{ list_published_at(\Carbon\Carbon::parse('2026-03-06 15:30:00')) }}
                                    </span>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="flex flex-col md:flex-row gap-2 md:gap-4 last:pb-0">
                            ...
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    ...
                                    <span class="text-xs font-medium text-gray-500">
                                        {{ list_published_at(\Carbon\Carbon::parse('2026-03-06 14:00:00')) }}
                                    </span>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="flex flex-col md:flex-row gap-2 md:gap-4 last:pb-0">
                            ...
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    ...
                                    <span class="text-xs font-medium text-gray-500">
                                        {{ list_published_at(\Carbon\Carbon::parse('2026-03-05 23:00:00')) }}
                                    </span>
                                </div>
                            </div>
                        </article>
