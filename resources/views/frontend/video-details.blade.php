                    ...
                    <div class="flex flex-col gap-6 w-full">
                        ...
                        <div class="flex flex-col gap-1 pb-2 mb-2">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-3 gap-4">
                                ...
                                @php $shareUrl = route('videos.show', $video->slug); @endphp
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url={{ urlencode($shareUrl) }}&text={{ urlencode($video->title) }}" target="_blank" rel="noopener noreferrer" class="w-7 h-7 p-0 border border-black flex items-center justify-center bg-black text-white hover:opacity-90 transition-all" title="X"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" viewBox="0 0 16 16">
