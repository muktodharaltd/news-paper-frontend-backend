                                        ...
                                        <div class="flex flex-col gap-0">
                                            ...
                                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <a href="{{ $telegramShareUrl }}" target="_blank" rel="noopener noreferrer" class="w-7 h-7 p-0 border border-[#229ED9] flex items-center justify-center bg-[#229ED9] text-white hover:opacity-90 transition-all" title="Telegram" aria-label="Share on Telegram"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 448 512" class="block" style="margin-left:-2px; margin-right:0;">
                                                            <path d="M446.7 98.6L52.7 251.2c-23.4 9-23.3 22.1-4.3 28l100.9 31.5 37.2 117.3c4.8 15 2.5 20.7 18.5 20.7 12.3 0 17.7-5.6 24.5-12.3 4.3-4.2 29.7-28.8 59.1-57.4l122.8 90.7c22.5 12.4 38.7 6 44.3-20.8l67.1-316.2c8.2-32.8-12.6-47.7-36.1-37.1zM231.4 347.1l-8.3 79.2-35.8-112.1 233.6-147.8-189.5 180.7z" />
                                                        </svg></a>
                                                    <a href="mailto:?subject={{ rawurlencode($emailSubject) }}&body={{ rawurlencode($emailBody) }}" class="w-7 h-7 p-0 border border-[#EA4335] flex items-center justify-center bg-[#EA4335] text-white hover:opacity-90 transition-all" title="Email" aria-label="Share via Email"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" viewBox="0 0 16 16">
                                                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v.217L8 8.993.001 4.217V4z"></path>
                                                            <path d="M0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.809-1.144l-6.57-4.027L8 9.583l-1.239-.753zM10.197 8.243L16 11.801V4.697l-5.803 3.546z"></path>
                                                        </svg></a>
